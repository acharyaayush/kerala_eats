...
<body>
   ...
   <nav class="navbar navbar-expand-lg main-navbar">
      ...
      <ul class="navbar-nav navbar-right">
         ...
         <li class="chat-support-icons"><i class="far fa-comment-dots" style="cursor: pointer;"></i></li>
         <li class="dropdown dropdown-list-toggle">
         ...
         <li class="dropdown">
            ...
            <?php 
              if($this->role == 1){
                  $profile_redirect_path = "admin/setting/2";//2 for account setting tab in super admin panel
              }else if($this->role == 2){
                  $profile_redirect_path = "admin/profile";//in merchant panel 
              }
            ?>
            <a href="<?php echo base_url().$profile_redirect_path; ?>" class="nav-link  nav-link-lg nav-link-user"><!--data-toggle="dropdown" -->
               <img alt="image" src="<?php echo base_url(); if(isset($this->profile_image) && $this->profile_image !=""){echo $this->profile_image;}else{ echo 'assets/img/avatar/avatar-1.png';}?>" class="rounded-circle mr-1">
               <div class="d-sm-none d-lg-inline-block">Hi, <?php if(isset($this->fullname)){echo $this->fullname;}?></div>
            </a>
           <!--  <div class="dropdown-menu dropdown-menu-right">
               <a href="<?php echo base_url(); ?>admin/admin_profile" class="dropdown-item has-icon">
               ...
               <a href="" class="dropdown-item has-icon" data-target="#change_password_popup" data-toggle="modal">
               <i class="fas fa-key"></i> Change Password
               </a>
               <div class="dropdown-divider"></div>
               <a href="<?php echo base_url(); ?>admin/login" class="dropdown-item has-icon text-danger">
   ...
   <div class="modal fade change-password-popup" id="change_password_popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                     ...
                     <div class="card-body">
                        <div class="form-group">
                           <div class="row">
                              ...
                              <div class="col-md-9">
                                 <input id="old-password" type="password" class="form-control pwstrength" name="password" required placeholder="Enter old password" minlength="6" maxlength="8" />
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="row">
                              ...
                              <div class="col-md-9">
                                 <input id="password" type="password" class="form-control pwstrength" name="password" required placeholder="Enter new password" minlength="6" maxlength="8" />
                        ...
                        <div class="form-group">
                           <div class="row">
                              ...
                              <div class="col-md-9">
                                 <input id="password-confirm" type="password" class="form-control" name="confirm-password" required placeholder="Enter confirm password"  minlength="6" maxlength="8"/>
                              </div>
                           </div>
                        </div>
                        <!-- <div class="form-group">
