...
<tr>
    <td>Greetings from <?php echo APP_NAME;?>. This is inform to you restaurant <b>"<?php echo $restaurant_name;?> , details modify by <?php echo APP_NAME;?> Administrator."</b>.</td>
</tr>
