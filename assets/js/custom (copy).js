...
//Auto reload restaurant list in second  ----set time interval ------START-----
 setInterval(function(){ $( "#res_table" ).load(BASE_URL+'admin/restaurant_list/2') }, 5000);
//Auto reload restaurant list in second  ----set time interval ------END-----
...
//Add and edit  resturant data submit ----------------START----------------
  ...
  $('body').on('click', '#add_edit_res_submit', function() {
        ...
        if(file1.length == 0 && exist_logo_image == ""){
          $('#unfill_logo_image').text('Please Select Logo Image');
        }else{
              
          $('#unfill_logo_image').text('');
        }

        if(file2.length == 0 && exist_banner_image == ""){
          $('#unfill_banner_image').text('Please Select Banner Image');
        }else{
              
          $('#unfill_banner_image').text('');
        }

        if(file3.length == 0 && exist_mobile_banner_image == ""){
          $('#unfill_mobile_banner_image').text('Please Select Mobile Image');
        }else{
       ...
       /* if(unit_number == ""){
        ...
        if(street_address == ""){
            ...
            $('#unfill_street_address').text('Please Fill Restaurant Street Address');
        }else{
            $('#street_address').css('border-color','#ccc');
       ...
       if(business_type == "" ){//If restaurant's business type is food then this column will contain value. So value 0 (if not applicable) 1 (Restaurant) 2 (Kitchen)
        ...
        var upload_logo_image_status = false;
        var upload_banner_image_status = false;
                   ...
                   if(response == 1){
                      if(active_status == 1){
                         ...
                         $('#'+restaurant_input_id).attr('checked','checked');
                           ...
                           swal(" Restaurant ("+restaurant_name+" )has been successfully actived", {
                                    icon: "success",
                                  });
                      }
                      if(active_status == 2){
                         $('#'+restaurant_input_id).removeAttr('checked','checked');
                          ...
                          swal(" Restaurant ("+restaurant_name+" ) has been successfully inactived", {
                                    icon: "success",
                                  });
                      }
            ...
            //monday
             ...
             var mon_break_time_mode =  $('#mon').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(mon_break_time_mode == 1){
                    ...
                    mon_break_start_time = "00:00";
                    mon_break_end_time = "00:00";
               }
            ...
            var tue_break_start_time = $('#tue_break_start_time').val();
             ...
             var tue_break_time_mode =  $('#tue').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(tue_break_time_mode == 1){
                    ...
                    tue_break_start_time = "00:00";
                    tue_break_end_time = "00:00";
               }
            ...
            var wed_break_start_time = $('#wed_break_start_time').val();
             ...
             var wed_break_time_mode =  $('#wed').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(wed_break_time_mode == 1){
                    ...
                    wed_break_start_time = "00:00";
                    wed_break_end_time = "00:00";
               }
            ...
            //Thursday
             ...
             var thu_break_time_mode =  $('#thu').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(thu_break_time_mode == 1){
                    ...
                    thu_break_start_time = "00:00";
                    thu_break_end_time = "00:00";
               }
             ...
             var fri_break_time_mode =  $('#fri').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(fri_break_time_mode == 1){
                    ...
                    fri_break_start_time = "00:00";
                    fri_break_end_time = "00:00";
               }
            ...
            var sat_break_start_time = $('#sat_break_start_time').val();
             ...
             var sat_break_time_mode =  $('#sat').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(sat_break_time_mode == 1){
                    ...
                    sat_break_start_time = "00:00";
                    sat_break_end_time = "00:00";
               }
             ...
             var sun_break_time_mode =  $('#sun').attr('mode');//  2- no(means admin dont want to add break time) , 1 yes(means admin want to add break time)
                 ...
                 if(sun_break_time_mode == 1){
                    ...
                    sun_break_start_time = "00:00";
                    sun_break_end_time = "00:00";
               }
...
//console.log(TimeData);
    ...
    if(check_empty_form_value == false){
        // Ajax-------SATRT------------
        $.ajax({
...
//Show Restaurant ---------Update Order Preparation Time of restaruant -------START-----
 $('body').on('click', '#rest_order_prepration_time_submit', function() {
     ...
     var  selected_restaurant_id = $('input[name="restaurant_id"]').val();
      ...
      if(rest_order_preparation_time !="" && rest_order_preparation_time != 0){
            // Ajax-------SATRT------------
                $.ajax({
                url: BASE_URL+'admin/update_order_preparation_time',
                data: { 
                    rest_order_preparation_time:rest_order_preparation_time,selected_restaurant_id:selected_restaurant_id
                },
                type: 'post',
                success: function(response){
                   if(response == 1){
...
//Show Restaurant --------Update Order Preparation Time of restaruant --------END-----
              ...
              success: function(promo_code_ponse){
                 if(promo_code_ponse == 1){
                    ...
                    if(active_status == 1){
                       ...
                       swal(" Promo Code ("+promo_code_name+" )has been successfully actived", {
                                icon: "success",
                              });
                    ...
                    if(active_status == 2){
                       $('#'+promo_code_input_id).removeAttr('checked','checked');
                        ...
                        swal(" Promo Code ("+promo_code_name+" )has been successfully inactived", {
                                icon: "success",
                              });
                    }
                    ...
                    setTimeout(function(){
                      ...
                      }, 2000); //refpromo_code_h every 2 seconds
...
// Add id when click on edit customer edit pen btn then it will add id on  modal box 
// show data ----START---
$( document ).ready(function() {
  $('body').on('click', '.edit_customer_btn', function() {
      var edit_customer_modal_id = $(this).attr('data-id');
      $('.edit-customer').attr('id', edit_customer_modal_id);
       var res = edit_customer_modal_id.split("edit_customer_popup_");
       var user_id = res[1];
       $('#customer_id').val(user_id);

      $.ajax({
              url:  BASE_URL+'admin/get_customer_detail',
              type: 'post',
...
// Add id when click on edit customer edit pen btn then it will add id on  modal box ----END---
   ...
   var new_user_table_url = user_table_url.replace("table","2");// if action mode then it will repalce table to  2 // it is becouse when delete success then it will give new url which will comapre segment with serach filter
    ...
    var customer_id = $("#customer_id").val(); // user id and merchant id is same
     ...
     if(fullname == ""){
        ...
        // Check file selected or not
        if(fullname != "" && email != ""  && mobile != "" && email_status == true){
           
           $.ajax({
              url:  BASE_URL+'admin/edit_customer_details/',
              type: 'post',
              data: {fullname :fullname , email:email, mobile:mobile, user_id:user_id},
       ...
       if($(event.target).is('.product_status')) {//check wich element is clicked
        ...
        if(offline_tag == 1){
          ...
          //required fields
           ...
           //from date and time
           var offline_product_fromdate = $('#offline_product_fromdate').val();
           

          //till date and time
           var offline_product_tilldate = $('#offline_product_tilldate').val();
          

            //required fields--------------start-----------
             if(offline_product_fromdate == ""){
                 $('#offline_product_fromdate').css('border-color','red');
                 $('#unfill_offline_product_fromdate').text('Please Select Day');
              }else{
                 $('#offline_product_fromdate').css('border-color','#ccc');
                 $('#unfill_offline_product_fromdate').text('');
              }

             if(offline_product_tilldate == ""){
                 $('#offline_product_tilldate').css('border-color','red');
                 $('#unfill_offline_product_tilldate').text('Please Select Day');
              }else{
                 $('#offline_product_tilldate').css('border-color','#ccc');
                 $('#unfill_offline_product_tilldate').text('');
              }
               //required fields--------------end-----------
           ...
           $.ajax({
                ...
                success: function(response){
                   if(response == 1){
                       ...
                       $('#offline_product_fromdate').val('');
                       $('#offline_product_fromtime').val('00:00:00');
                       $('#offline_product_tilldate').val('');
                          ...
                          var load =  $( "#product_and_category_list_table" ).load(new_product_table_url);
                            ...
                            if(offline_type == 2){
                               $('#'+product_input_id).attr('checked','checked');
                                swal('Success', 'Product ( '+product_name+' ) has been successfully Enabled!', 'success');
                            ...
                            if(offline_type == 1){
                               ...
                               swal('Success', 'Product ( '+product_name+' ) has been successfully Disabled!', 'success');
                            }
                        }, 2000); //refproduct_h every 2 seconds
      ...
      //selected category id which you want to go online /offline
       if($(event.target).is('.category_status')) {//check wich element is clicked
        ...
        if(offline_tag == 1){
           ...
           var days_offline_fromdate = $('#days_offline_fromdate').val();
           var days_offline_fromtime = $('#days_offline_fromtime').val();
           var offline_tag_value = days_offline_fromdate+' '+days_offline_fromtime;
          ...
          //required fields
           ...
           //from date and time
           var offline_category_fromdate = $('#offline_category_fromdate').val();
           var offline_category_fromtime = $('#offline_category_fromtime').val();

          //till date and time
           var offline_category_tilldate = $('#offline_category_tilldate').val();
           var offline_category_tilltime = $('#offline_category_tilltime').val();

            //required fields--------------start-----------
             if(offline_category_fromdate == ""){
                 $('#offline_category_fromdate').css('border-color','red');
                 $('#unfill_offline_category_fromdate').text('Please Select Day');
              }else{
                 $('#offline_category_fromdate').css('border-color','#ccc');
                 $('#unfill_offline_category_fromdate').text('');
              }

             if(offline_category_tilldate == ""){
                 $('#offline_category_tilldate').css('border-color','red');
                 $('#unfill_offline_category_tilldate').text('Please Select Day');
              }else{
                 $('#offline_category_tilldate').css('border-color','#ccc');
                 $('#unfill_offline_category_tilldate').text('');
              }
               //required fields--------------end-----------

              if(offline_category_fromdate != "" && offline_category_fromtime != ""){
                  var offline_tag_value = offline_category_fromdate+' '+offline_category_fromtime+','+offline_category_tilldate+' '+offline_category_tilltime;
              }else{
                  var offline_tag_value = "";
              }
        }
           ...
           $.ajax({
                ...
                success: function(response){
                   if(response == 1){
                       ...
                       $('#days_offline_fromdate').val('');
                       $('#hours_offline_value').val('');
                       $('#offline_category_fromdate').val('');
                       $('#offline_category_fromtime').val('00:00:00');
                       $('#offline_category_tilldate').val('');
                      ...
                      setTimeout(function(){
                          ...
                          if(offline_type == 2){
                             $('#'+category_input_id).attr('checked','checked');
                              swal('Success', 'Category ( '+category_name+' ) has been successfully Enabled!', 'success');
                          ...
                          if(offline_type == 1){
                             ...
                             swal('Success', 'Category ( '+category_name+' ) has been successfully Disabled!', 'success');
                        ...
                        }, 2000); //refcategory_h every 2 seconds
      ...
      setInterval(function(){ 
        var is_madal_open = $(".modal").hasClass("show");
          if(is_madal_open == false){
              ...
              $("#cat_disp_img").attr('src',BASE_URL+'assets/img/avatar/avatar-1.png');
  ...
  $('body').on('click', '#category_submit', function() {
      ...
      var category_id = $("#edit_category_id").val(); // user id and category id is same
       ...
       if(category_name == ""){
          ...
          // Check file selected or not
          if(category_name != "" && category_description != ""   && (upload_category_image_status == true || edit_category_image_exist !="" )&&selected_restaurant_id != ""){
  ...
  $('body').on('click', '.product_mode_type_btn', function() {
       ...
       if(product_mode_type == 2){
                    ...
                    success: function(response){
                      if(response != 0){
                         var data = JSON.parse(response);
                          ...
                          {
                              var food_type_val = $(this).val();

                              if(food_type_val == data.is_veg){
                                $("#food_type option").attr('selected','selected');
                              }
                          });
        ...
        //reset form data ----------START--------------
          $('#add_edit_product_popup').find("input,textarea,select,input[type=file]").val('').end().find("input[type=checkbox], input[type=radio]").prop("checked", "").end();
...
*/
        ...
        if(food_type == ""){
            ...
            $('#unselect_food_type').text('Please Fill product Description');
        }else{
...
$('body').on('click', '.selected_variant_type_id', function() {
     var selected_variant_type_array = [];
      ...
      $.each(selected_variant_type_array, function (index, value) {  
             ...
             $("#selected_variant_type_for_add_price").append('  <div class="row vairant_type_input">'
                                   +' <div class="col-sm-4"> '
                                      +' '+value.variant_type_name+''
                                  +'  </div>'
                                   +'  <div class="col-sm-4"><span class="currency variant_currency">S$</span>'
                                   +'     <input type="number" min="1" minlength="1" maxlength="5" class="check_space variant_price_input" id="variant_type_price_'+value.variant_type_id+'" value="">&nbsp;<span class="error" id="unfill_variant_type_price_'+value.variant_type_id+'"></span>'
                                   +' </div>'
                                   +'  <div class="col-sm-4"> '
                                   +' <div class="row">'
                                   +'   <div class="col-sm-4">'
                                   +'     <label class="enabled-label" data-children-count="1">'
                                    +'         <input type="radio" name="variant_type_set_as_default" class="default_variant_type_id" value="'+value.variant_type_id+'">'
                                    +'         <span class="checkmark"></span>'
                                    +'      </label>'
                                     +' </div>'
                                     +'  <div class="col-sm-8 text-right">'
                                     +'    <a class="remove_added_variant_type_element" id="'+value.variant_type_id+'" data-id="" data-toggle="tooltip" title="" data-original-title="Delete">'
    ...
    if(selected_product_id != "" && selected_variant_id !="" && ((default_variant_type_id_check != undefined && default_variant_type_id !="") || (default_variant_type_id_check == undefined && default_variant_type_id =="")) && variant_select_type_status == true  && (variant_select_limit != "" || variant_select_limit == "")&& array_variant_for_product.length != 0 && check_price_is_fill !="" && check_price_is_fill == true){
         ...
         // Ajax-------SATRT------------
            $.ajax({
                    ...
                    data: { 
                        selected_product_id: selected_product_id,selected_variant_id:selected_variant_id,default_variant_type_id:default_variant_type_id,variant_select_type:variant_select_type,json_of_variant_type:array_variant_type_data,variant_select_limit:variant_select_limit
                    },
                    type: 'post',
                    success: function(response){
                        if(response == 1){
                            $('#add_edit_variant_in_product').modal('hide');
                            $('#view_product_id_variant_'+selected_product_id).trigger('click');
...
//Show available vairants in selected product --------------------------START--------------------
  $('body').on('click', '.view_avaible_variant_in_product', function() {
      var selected_product_id = $(this).attr('edit_product_id');
...
//order page-------------------------START---------------------------
 ...
 setInterval(function(){ $( "#all_Orders_table" ).load(BASE_URL+'admin/orders/2') }, 5000);
...
$('body').on('click', '#search_order_list_data,.export_orders_csv', function() {
    ...
    if(from_date!='all' || to_date !='all'  || delivery_handle_by !='all' || payment_mode!='all' || paid_status!='all' || is_paid_to_restaurant!='all' || order_status!='all' || search_restaurant_id!='all' || search_customer_id!='all' || order_accept_type!='all' || business_category_id!='all' || is_cutlery_needed!='all' || is_promocode_auto_applied!='all' || is_promocode_auto_applied_on_delivery!='all' || search !='all'){
            ...
            if(search_mode == 1){
                var controller_path = 'orders/0'; //for order search
      ...
      // Ajax-------SATRT------------
        ...
        success: function(response){
            ...
            if(response == 1){
             ...
             swal("Paid Status Has been Changed", {
                icon: "success",
              });
...
//order single page ----------------------Print order view START-------------------------
 $('body').on('click', '#order_details_print', function(e) {
        //window.print();
            $('#ingnore_print_time').addClass('d-none');
            var printContents = $('#print_section').html();
...
//order single page -------EDIT Customer delivery address--------START------------ 
...
//order single page ------EDIT Customer delivery address -------END------------ 
            ...
            // Ajax-------SATRT------------
                ...
                success: function(response){
                   if(response == 1){
                      ...
                      $('#updated_schedule_time').text(edit_order_schedule_time);
...
//order single page ------- Deduct Outstanding Amount from Customer wallet--------START------------ 
 $('body').on('click', '#deduct_outstanding_amount_submit', function() {

     var outstanding_amount_for_deduct = $('input[name="outstanding_amount_for_deduct"]').val();
        if(outstanding_amount_for_deduct == "" ||  outstanding_amount_for_deduct == 0){
            $('input[name="outstanding_amount_for_deduct"]').css('border-color','red');
            $('#unfill_outstanding_amount').text('Please Fill Preparation Time');
        }else{
            $('input[name="outstanding_amount_for_deduct"]').css('border-color','#ccc');
            $('#unfill_outstanding_amount').text('');
        }
       
      if(outstanding_amount_for_deduct !="" && outstanding_amount_for_deduct != 0){
            // Ajax-------SATRT------------
                $.ajax({
                url: BASE_URL+'admin/insert_debit_outstanding_amount_in_customer_wallet',
                data: { 
                    outstanding_amount_for_deduct:outstanding_amount_for_deduct,selected_order_id:order_id,customer_id:customer_id
                },
                type: 'post',
                success: function(response){
                   if(response == 1){
                     /* swal("Preparation Time Updated Successfully!", {
                      ...
                      //$('#deduct_amount_from_customer_wallet').modal('hide');
                       window.location.replace(BASE_URL+'admin/order_single/'+order_id);
                     }
                   if(response == 0){
                      swal('Oops...', 'Something went wrong!', 'error');
...
//order single page ------Deduct Outstanding Amount from Customer wallet-------END------------ 
